...
if calc_cons:
    cell_faces_L, sup_cells_L = pot.calc_distribution_cell(E_faces_L_tot, input_cells, head, cells, area_cell, report, sup_disp, posiciones)
else:
    cell_faces_L, sup_faces_L = pot.distribution_cells(E_cons[-1], E_faces_L_tot, head, posiciones, area_cell, report, caras = caras, distribucion = porcentaje_celdas, case = "Laboratorio")
...
if calc_cons:
    cell_faces_B, sup_cells_B = pot.calc_distribution_cell(E_faces_B_tot, input_cells, head, cells, area_cell, report, sup_disp, posiciones)
else:
    cell_faces_B, sup_faces_B = pot.distribution_cells(E_cons[-1], E_faces_L_tot, head, posiciones, area_cell, report, caras = caras, distribucion = porcentaje_celdas, case = "Laboratorio")
...
if calc_cons:
    cell_faces_E, sup_cells_E = pot.calc_distribution_cell(E_faces_E_tot, input_cells, head, cells, area_cell, report, sup_disp, posiciones)
else:
    cell_faces_E, sup_faces_E = pot.distribution_cells(E_cons[-1], E_faces_L_tot, head, posiciones, area_cell, report, caras = caras, distribucion = porcentaje_celdas, case = "Laboratorio")
