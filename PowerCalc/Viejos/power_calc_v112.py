...
calc_cons, T, porcentaje_celdas, consumo_file, case, caras, cells, distrib_type, sup_disp, power_case, report, distribucion= pot.set_params_condiciones(mision, file, n_cases)
...
P_faces_L = pot.pot_faces(fechas_gen, cos, Pmp, head, area_cell, file, graph = "Potencia de las caras", case = "Laboratorio")
...
P_faces_B = pot.pot_faces(fechas_gen, cos, Pmp_B, head, area_cell, file, graph = "Potencia de las caras", case = "BOL")
...
P_faces_E = pot.pot_faces(fechas_gen, cos, Pmp_E, head, area_cell, file, graph = "Potencia de las caras", case = "EOL")
