...
def set_params_condiciones(cond, file, n_cases):
    ...
    if calc_cons:
        ...
        if distrib_type == "%":
            ...
            while len(distribucion)!= n_cases+5:
                distribucion = list(map(float,ast.literal_eval(input(f"La longitud de la variable sup_disp no coincide con la cantidad de planos de la simulación. Definir nuevamente sup_disp con longitud {n_cases+5}:\n"))))
