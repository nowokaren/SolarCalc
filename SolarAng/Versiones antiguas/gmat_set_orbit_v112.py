...
def set_params_mec_orbit(section_ini):
    ...
    return name, Epoch, SMA, ECC, INC, RAAN, AOP, TA, ARB, BAV, ACT, BCV, step, duration_run, stepWC, duration_runWC, script_name, paneles, start_periodWC, end_periodWC, startWC, endWC
