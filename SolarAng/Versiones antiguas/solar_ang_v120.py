...
if duration_run > corte_subrun:
    ...
    cosWC, axes, paneles, n_max2, Z_max2, plano_max_s2, name_plano_max = om.add_plano_max(file, cosWC, axes, paneles, name_plano_max, graph = True, case = "simulacion2")
    ...
    if duration != []:
        ...
        cosWC, axes, paneles, n_max1, Z_max1, plano_max_s1, name_plano_max = om.add_plano_max(file, cosWC, axes, paneles, name_plano_max, case = "simulación1")
...
if duration != []:
    ...
    cosWC, axes, paneles, n_max3, Z_max3, plano_max_s3, name_plano_max = om.add_plano_max(file, cosWC, axes, paneles, name_plano_max, case = "periodoWC")
