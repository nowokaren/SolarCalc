...
def time_interval(file, name, values, num_orbWC, duration_run2, step, start, end, axes, paneles, period = 1, name_plano_max = 1, eclip_dur = 1, case_in = 1, case_out = "periodoWC" ) :      
    ...
    print_report(file, name, values, period, num_orbWC[:,1][-1], axes, duration_run2, step, name_plano_max, eclip_dur, case = case_out)
